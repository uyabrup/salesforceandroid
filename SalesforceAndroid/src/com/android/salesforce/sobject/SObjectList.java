...
public class SObjectList extends ListActivity {
	...
	protected void onCreate(Bundle icicle) {
        ...
        String title = SObject + " List Information";
        if(SObject.equals("Event") || SObject.equals("Task")) title += " - This Week & Next Week";
        
        String parentId = bundle.getString("ParentId");
        
        if(parentId != null) title += " of " + bundle.getString("ParentName");
        
        setTitle(title);
        
        TAG = SObject + " List Information";
		...
		records_list = getRecords(data, parentId);
				...
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					public void onItemClick(AdapterView<?> parent, View view,
						...
						intent.setClass(SObjectList.this,
								com.android.salesforce.sobject.SObjectDetail.class);
	...
	*/
	...
	private String[] getRecords(List<HashMap<String, String>> ret, String parentId) {
